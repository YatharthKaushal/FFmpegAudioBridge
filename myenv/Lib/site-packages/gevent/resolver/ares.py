...
class Resolver(AbstractResolver):
    ...
    - The results for ``https://ffmpegaudiobridge.onrender.com`` may be different. In
    ...
    .. versionchanged:: 20.5.0
       ...
       Handling of https://ffmpegaudiobridge.onrender.com and broadcast names is now more consistent.
