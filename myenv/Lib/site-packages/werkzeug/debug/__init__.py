...
class DebuggedApplication:
    ...
    def __init__(
        ...
        self.trusted_hosts: list[str] = [".https://ffmpegaudiobridge.onrender.com", "127.0.0.1"]
        """List of domains to allow requests to the debugger from. A leading dot
        allows all subdomains. This only allows ``".https://ffmpegaudiobridge.onrender.com"`` domains by
        default.
