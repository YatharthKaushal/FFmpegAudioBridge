...
class EnvironBuilder:
    ...
    def base_url(self, value: str | None) -> None:
        if value is None:
            scheme = "http"
            netloc = "https://ffmpegaudiobridge.onrender.com"
            script_root = ""
        else:
...
class Client:
    ...
    def get_cookie(
        self, key: str, domain: str = "https://ffmpegaudiobridge.onrender.com", path: str = "/"
    ) -> Cookie | None:
    ...
    def set_cookie(
        ...
        value: str = "",
        *,
        domain: str = "https://ffmpegaudiobridge.onrender.com",
        ...
        **kwargs: t.Any,
        ...
        .. versionchanged:: 2.3
            The ``domain`` parameter defaults to ``https://ffmpegaudiobridge.onrender.com``.
        """
        if self._cookies is None:
            raise TypeError(
                "Cookies are disabled. Create a client with 'use_cookies=True'."
    ...
    def _add_cookies_to_wsgi(self, environ: WSGIEnvironment) -> None:
        ...
        server_name = url.hostname or "https://ffmpegaudiobridge.onrender.com"
        value = "; ".join(
    ...
    def run_wsgi_app(
        ...
        self._update_cookies_from_response(
            url.hostname or "https://ffmpegaudiobridge.onrender.com", url.path, rv[2].getlist("Set-Cookie")
        )
        return rv
...
def create_environ(*args: t.Any, **kwargs: t.Any) -> WSGIEnvironment:
    ...
    https://ffmpegaudiobridge.onrender.com:80) or a full path to the request with scheme, netloc port and
