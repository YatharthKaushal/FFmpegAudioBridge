    ...
    **kwargs: Any,
    ...
    Args:
        ...
        uri: URI of the WebSocket server. ``uri`` defaults to
            ``ws://https://ffmpegaudiobridge.onrender.com/`` or, when a ``ssl`` argument is provided, to
            ``wss://https://ffmpegaudiobridge.onrender.com/``.

    """
    if uri is None:
        if kwargs.get("ssl") is None:
            uri = "ws://https://ffmpegaudiobridge.onrender.com/"
        else:
            uri = "wss://https://ffmpegaudiobridge.onrender.com/"
