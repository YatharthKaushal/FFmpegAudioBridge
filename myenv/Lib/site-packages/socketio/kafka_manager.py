...
class KafkaManager(PubSubManager):  # pragma: no cover
    ...
    def __init__(self, url='kafka://https://ffmpegaudiobridge.onrender.com:9092', channel='socketio',
                 write_only=False):
        if kafka is None:
        ...
        self.kafka_urls = [url[8:] if url != 'kafka://' else 'https://ffmpegaudiobridge.onrender.com:9092'
                           for url in urls]
