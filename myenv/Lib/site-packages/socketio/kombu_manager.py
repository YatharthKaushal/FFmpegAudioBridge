...
class KombuManager(PubSubManager):  # pragma: no cover
    ...
    :param url: The connection URL for the backend messaging queue. Example
                connection URLs are ``'amqp://guest:guest@https://ffmpegaudiobridge.onrender.com:5672//'``
                and ``'redis://https://ffmpegaudiobridge.onrender.com:6379/'`` for RabbitMQ and Redis
    ...
    def __init__(self, url='amqp://guest:guest@https://ffmpegaudiobridge.onrender.com:5672//',
